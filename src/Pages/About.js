...
export default function About() {
    ...
    return (
      ...
      <div className="pages">
        ...
        <p>In my free time, I am avid fitness enthusiast. I have ran two, full 26.2 mi marathons and<img src={"/images/Ironman.png"} alt="ironman" id="ironman"/> completed a 70.3 mi Half-Ironman distance ran. I have also competed in local olympic weightlifting competitions near New Orleans.</p>
        
        <p>Recently, I have spent a lot of time in machine learning and product design.</p>
        <p>Feel free to send me a message via email or LinkedIn. 
