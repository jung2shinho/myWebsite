...
export default function Resume() {
    return (
      ...
      <p> Professional Mechanical Engineer (PE) – State of Oregon <br />
      Project Management Professional (PMP) Certified <br />
      Active Department of Defense (DoD) Top Secret Clearance <br />
      </p>
      ...
      <ul>
        ...
        <li>Developed a $7.3M base services contract with Vectrus Incorporated for the daily operations and maintenance of utilities and specialized equipment, supporting anti-terrorism, security, and fire protection. 
        </li>
      </ul>
      </div>
    )
